    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.usuarios.getusers') }}">Listar Usuarios</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        {!! Form::model($user, ['route' => ['admin.usuarios.update', $user->id], 'id' => "quickForm"]) !!}
                        @include('admin.users.mentor.form')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-footer">
                                    <a href="{{ route('admin.usuarios.add') }}"><button type="submit" class="btn btn-primary btn-block">Editar usuario</button></a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card-footer">
...
$(function () {
  ...
  document.getElementById("adminusuarioopen").className += ' menu-open';    
  document.getElementById("adminusuarioactive").className += " active";    
  document.getElementById("adminmentoruser").className += " active";    
});
</script>
