...
<body>
    ...
    <div>
        ...
        <p style="font-family: 'Inter', sans-serif; font-size: 12x; font-weight: bold; text-align: center;">SEGUIMIENTO DE ALMAS NUEVAS</p>    
        <div style="margin-top: 10px;">
            <hr style="border-top: 1px trashed;">
            <table id="table">
                <tbody>
                    @foreach(array_reverse($asistencias) as $asis)
                        <?php                            
                            ...
                            $mes = $meses[date('n', strtotime($asis->FecAsi))];
                            $dia = $dias[date('N', strtotime($asis->FecAsi))];
                            $dia_numero = date('d', strtotime($asis->FecAsi));
                            $anio = date('Y', strtotime($asis->FecAsi));
                        ?>
                        <!-- ESPACIADO -->
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td colspan="4" style="font-size: 13px; font-weight: bold;">NUEVOS ENTREGADOS PRESENCIALMENTE - {{ $dia.' '.$dia_numero .' DE '.$mes.' DEL '.$anio }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td bgcolor="#845db0" style="color: white; font-weight: bold; font-size: 12px; text-align: center; padding-bottom: 3px;">{{ $red->NOM_RED }}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="td" style="font-weight: bold; width: 15%" bgcolor="#a0bfd9">LIDER ASIGNADO</td>                            
                        ...
                        @foreach($members as $member)                            
                            <?php if(date('Y-m-d', strtotime($asis->FecAsi)) == $member['Fecha']){ ?>
                            @if($member['faltas']>3)
                            ...
                            @if($member['estado'])
                                @switch($member['estado'])
                                    ...
                                    @default
                                        <tr>
                                @endswitch                                                                    
                                    <td colspan="2" class="td" style="font-weight: bold; text-align: center;">ESTADO :</td>
                                    <td class="td" style="text-align: center;">{{ $member['estado'] }}</td>
                                    <td class="td" style="font-weight: bold; text-align: center;">OBSERVACIÓN :</td>
                                    <td colspan="8" class="td" style="text-align: center;">{{ $member['observacion'] }} </td>
                                </tr>
                            @endif
                            <?php $i++; } ?>                          
                        @endforeach                        
