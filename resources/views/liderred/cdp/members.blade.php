        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('liderred.getcdp') }}">Ver Casas de Paz</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @endif
                    ...
                    <td style="font-weight: bold;">                        
                        <a href="{{ route('liderred.details.show', 'MCDP'.$member->CodCon) }}">
...
<script>
  $(function () {
    ...
    document.getElementById("menumiembroscpopen").className += ' menu-open';    
    document.getElementById("menumiembroscpactive").className += " active";    
    document.getElementById("cps").className += " active";    
  });
