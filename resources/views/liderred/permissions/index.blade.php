...
function disablePermission(numreg){
  $.ajax({
    ...
    type:'POST',
    url:'/permisos/deshabilitar-permiso',
    data:{
        "_token": "{{ csrf_token() }}",
        "numreg": numreg
      },
...
function enablePermission(numreg){
  $.ajax({
    ...
    type:'POST',
    url:'/permisos/habilitar-permiso',
    data:{
        "_token": "{{ csrf_token() }}",
        "numreg": numreg
      },
