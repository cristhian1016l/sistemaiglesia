        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <?php
                if(isset($cdp)){
                    ?>
                        <li class="breadcrumb-item"><a href="{{ URL::previous()  }}">Regresar a la lista de miembros</a></li>
                    <?php
                }else{
                    ?>
...
<script>
$(function(){
    document.getElementById("menumembresiaopen").className += ' menu-open';    
    document.getElementById("menumembresiaactive").className += " active";    
    document.getElementById("membresia").className += " active";    
})
</script>
@endsection