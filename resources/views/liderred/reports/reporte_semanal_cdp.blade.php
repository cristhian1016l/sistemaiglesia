            ...
            <table id="table">
                <thead>
                    ...
                    <tr>
                        ...
                        <th style="width: 10%; font-size: 10px; background-color: #c7c71e">CDP</th>
                        <th style="width: 10%; font-size: 10px; background-color: #c7c71e">CULTOS</th>
                        <th style="width: 45%; font-size: 10px; background-color: #c7c71e">OBSERVACIÓN Y/O MOTIVO DE FALTA</th>
                    </tr>                    
                </thead>
                <tbody>                     
                    @foreach($dato['miembros'] as $key=>$miembro)
                        <tr>
                            ...
                            <td class="td" style="text-align: left !important; padding-left: 10px;">
                                {{ $miembro['miembro']->ApeCon.' '.$miembro['miembro']->NomCon }}
                            </td>
                            <td class="td"></td>
